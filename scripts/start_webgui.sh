...
# 使用conda运行streamlit
conda run -n crossmedia streamlit run apps/video_test_webgui.py \
...
import sys
sys.argv = ['streamlit', 'run', 'apps/video_test_webgui.py', '--server.headless=true', '--browser.gatherUsageStats=false']
